...
export class LeaderboardService {
  ...
  async addDailyScore(postId: string, memberKey: string, score: number, time: number, dateString: string) {
    const { leaderboardKey, timeKey } = this.getKeys('daily', dateString, postId);
